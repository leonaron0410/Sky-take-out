...
//
    ...
    @Override
    public PageResult showHistoryOrders(int page, int pageSize, Integer status) {
        ...
        if (ordersPage != null && ordersPage.getTotal() != 0) {
            for (Orders orders : ordersPage) {
                ...
                List<OrderDetail> orderDetailList = orderDetailMapper.listAllByOrderId(id);
